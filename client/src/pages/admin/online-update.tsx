    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          placeholder="e.g., Download, Update Now, Learn More"
        />
      </div>

      <div className="space-y-2">
        <Label htmlFor="linkUrl">Link URL {formData.buttonText && "(Required)"}</Label>
        <Input
          id="linkUrl"
          type="url"
      ...
      <div className="flex items-center space-x-2">
        ...
        />
        <Label htmlFor="isActive">Active (visible to apps)</Label>
      </div>
